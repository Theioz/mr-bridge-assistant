...
- **Body & Fitness "today" → "yesterday"** in [body-fitness-summary.tsx](web/src/components/dashboard/body-fitness-summary.tsx). Matches the real semantic (Oura/Fitbit data is dated to yesterday; the "today" row always read as the previous day's numbers). Fits inside the 140px-min cell at `--t-micro`.
