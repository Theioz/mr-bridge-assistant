...
| `AFTERSHIP_API_KEY` | [admin.aftership.com](https://admin.aftership.com/api) → API Keys *(optional — package delivery banner; resolves carrier ETAs from Gmail-extracted tracking numbers; free tier: 50 trackings/month)* |
