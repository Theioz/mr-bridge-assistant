...
export async function POST(req: Request) {
  ...
  const system = [
    ...
    "would be wrong.",
    "",
    "`reply` is what the USER SEES. It must be a short sentence, never a field name and",
    "never a slot value.",
    "",
    "EXAMPLES",
    'User: "add 50g of white rice"',
    '  {"reply":"Added 50g of white rice.","intent":"adjust","additions":"50g white rice",',
    '   "removals":[],"scale":null}',
    "",
    'User: "actually double the whole thing"',
    '  {"reply":"Doubled the whole meal.","intent":"adjust","additions":"",',
    '   "removals":[],"scale":2}',
    "",
    'User: "without the oil"',
    '  {"reply":"Removed the oil.","intent":"adjust","additions":"","removals":["oil"],',
    '   "scale":null}',
    "",
    'User: "how much protein is in this?"',
    '  {"reply":"53g of protein.","intent":"question","additions":"","removals":[],',
    '   "scale":null}',
    "",
    'User: "log it"',
    '  {"reply":"Logging it now.","intent":"log","additions":"","removals":[],"scale":null}',
  ].join("\n");
